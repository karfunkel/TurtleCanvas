...
griffon {
    doc {
        logo = '<a href="http://griffon.codehaus.org" target="_blank"><img alt="The Griffon Framework" src="../img/turtle-128x128.png" border="0"/></a>'
        sponsorLogo = "<br/>"
...
deploy {
    application {
        ...
        icon {
            'default' {
                name   = 'turtle-64x64.png'
                width  = '64'
                height = '64'
            }
            splash {
                name   = 'turtle-128x128.png'
                width  = '128'
                height = '128'
            }
            selected {
...
app.fileType = '.groovy'
app.defaultPackageName = 'turtlecanvas'
